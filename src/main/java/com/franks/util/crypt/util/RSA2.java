 ...
 */
public class RSA2 extends RSABase {
    ...
    public static String sign(String content, String privateKey, String characterEncoding) {
        return sign(content, privateKey, SIGN_SHA256RSA_ALGORITHMS, characterEncoding);
    }
    ...
    public static boolean verify(String content, String sign, String publicKey, String characterEncoding) {
        return verify(content, sign, publicKey, SIGN_SHA256RSA_ALGORITHMS, characterEncoding);
    }
    ...
    public static boolean verify(String content, String sign, String publicKey) {
        return verify(content, sign, publicKey, SIGN_SHA256RSA_ALGORITHMS, Constant.CHARSET);
    }
}
